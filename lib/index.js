...
function RpcClient(opts) {
  console.log("ainsig_test: opts - " + JSON.stringify(opts));
  opts = opts || {};
  ...
  this.bitcore_version = opts.bitcore_version || 0.16;
  this.bitcore = 0.18;

  console.log("ainsig_test: version -" + bitcore_version);
...
// rewrites deprecated method requests to new method name
function mapDeprecatedMethods(self, request) {
  console.log("ainsig_test: attempting to map deprecated methods for request: " + request + " v - " + self.bitcore_version)
  if (self.bitcore_version > 0.16 && self.bitcore > 0.16 && request.method === "getaccountaddress") {
    console.log("ainsig_test: mapping getaccountaddress");
    request.method = 'getnewaddress';
    console.log("ainsig_test: mapped success");
  }
}
...
function rpc(request, callback) {
  ...
  mapDeprecatedMethods(self, request);
